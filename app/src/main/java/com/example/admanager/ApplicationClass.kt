...
class ApplicationClass:Application() {
    ...
    override fun onCreate() {
        ...
        AdParamsPrefs.saveParams(AdRequestParamModel("ca-app-pub-3940256099942544/6300978111","ca-app-pub-3940256099942544/6300978111","ca-app-pub-3940256099942544/1033173712","ca-app-pub-3940256099942544/3419835294",0,true,true,true,true),this)
